...
from cadpy_common.assembly_spec import REPO_ROOT, find_step_path, resolve_cad_source_path
from cadpy_common.cad_ref_syntax import normalize_cad_path, parse_cad_tokens
...
from cadpy_common.step_scene import step_file_hash
...
class EntryTarget:
    ...
    @property
    def token(self) -> str:
        from cadpy_common.cad_ref_syntax import build_cad_token
