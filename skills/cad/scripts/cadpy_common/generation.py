...
from cadpy_inspect.inspect_refs.analysis import selector_manifest_diff
from cadpy_common.assembly_composition import (
    AssemblyCompositionError,
    build_linked_assembly_composition,
    build_native_assembly_composition,
    component_name,
)
from cadpy_common.assembly_spec import REPO_ROOT, assembly_spec_children, read_assembly_spec
from cadpy_common.assembly_spec import assembly_spec_from_payload
from cadpy_common.catalog import (
    CAD_ROOT,
    CadSource,
    STEP_SUFFIXES,
    StepImportOptions,
...
def _mark_scene_python_backed(
    ...
    *,
    ...
    scene.source_hash = source_identity.digest
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.error("cadpy_common.generation is a library module.")
    return 2
