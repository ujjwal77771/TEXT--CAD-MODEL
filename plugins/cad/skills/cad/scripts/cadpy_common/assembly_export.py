...
from cadpy_common.assembly_flatten import AssemblyResolutionError, CatalogEntry
...
from cadpy_common.step_export import create_bin_xcaf_doc, export_xcaf_doc_step_scene
from cadpy_common.step_scene import LoadedStepScene, load_step_scene, load_step_scene_cached, load_step_scene_from_xcaf_doc, occurrence_selector_id
from cadpy_common.step_scene import _shape_hash
...
def _load_step_assembly_shape(step_path: Path, *, label: str):
    ...
    from cadpy_common.step_scene import scene_occurrence_shape
